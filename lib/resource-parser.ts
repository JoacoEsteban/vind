...
export type SerializableParentXPathObjectMinified = Omit<
  SerializableXPathObjectMinified,
  'c'
>
export type SerializableChildXPathObjectMinified = Omit<
  SerializableXPathObjectMinified,
  'p'
>
...
const SerializableXPathObject: z.ZodType<SerializableXPathObject> = z.lazy(() =>
  z.object({
    ...
    children: z.union([
      z.array(z.lazy(() => SerializableChildXPathObject)),
      z.null(),
    ]),
  }),
)

const SerializableParentXPathObject: z.ZodType<SerializableParentXPathObject> =
  z.lazy(() =>
    z.object({
      tagName: z.string(),
      attrs: z.array(z.tuple([z.string(), z.array(z.string())])),
...
const SerializableChildXPathObject: z.ZodType<SerializableChildXPathObject> =
  z.lazy(() =>
    z.object({
      tagName: z.string(),
      attrs: z.array(z.tuple([z.string(), z.array(z.string())])),
...
const SerializableXPathObjectMinified: z.ZodType<SerializableXPathObjectMinified> =
  z.lazy(() =>
    z.object({
      t: z.string(),
...
const SerializableParentXPathObjectMinified: z.ZodType<SerializableParentXPathObjectMinified> =
  z.lazy(() =>
    z.object({
      t: z.string(),
      a: z.array(z.tuple([z.string(), z.array(z.string())])),
...
const SerializableChildXPathObjectMinified: z.ZodType<SerializableChildXPathObjectMinified> =
  z.lazy(() =>
    z.object({
      t: z.string(),
      a: z.array(z.tuple([z.string(), z.array(z.string())])),
...
const ResourcePayloadMinifiedExpander: ZodEffects<
  typeof ResourcePayloadMinified,
  ResourcePayload
> = ResourcePayloadMinified.transform((minified) => {
  return {
...
const ResourcePayloadMinifier: ZodEffects<
  typeof ResourcePayload,
  ResourcePayloadMinified
> = ResourcePayload.transform((payload) => {
  return {
...
const expandBinding = BindingPayloadMinified.transform<BindingPayload>(
  (minified) => {
    return {
      id: minified.i,
      domain: minified.d,
...
const minifyBinding = BindingPayload.transform<BindingPayloadMinified>(
  (payload) => {
    return {
      i: payload.id,
      d: payload.domain,
      ...
      p: payload.path,
      s: payload.selector,
      x: payload.xpathObject
        ? minifyXPathObject.parse(payload.xpathObject)
        : null,
    }
  },
)

const minifyXPathObject =
  SerializableXPathObject.transform<SerializableXPathObjectMinified>(
    (expanded) => {
      return {
        t: expanded.tagName,
        a: expanded.attrs,
        p: expanded.parent
          ? minifyParentXPathObject.parse(expanded.parent)
          : null,
        c: expanded.children
          ? expanded.children.map((c) => minifyChildXPathObject.parse(c))
          : null,
      }
    },
  )

const minifyParentXPathObject: ZodEffects<
  typeof SerializableParentXPathObject,
  SerializableParentXPathObjectMinified
> =
  SerializableParentXPathObject.transform<SerializableParentXPathObjectMinified>(
    (expanded) => {
      return {
        t: expanded.tagName,
        a: expanded.attrs,
...
const minifyChildXPathObject: ZodEffects<
  typeof SerializableChildXPathObject,
  SerializableChildXPathObjectMinified
> = SerializableChildXPathObject.transform((expanded) => {
  return {
    t: expanded.tagName,
    a: expanded.attrs,
    c: expanded.children
...
const expandXPathObject =
  SerializableXPathObjectMinified.transform<SerializableXPathObject>(
    (minified) => {
      return {
        tagName: minified.t,
        attrs: minified.a,
        ...
        children: minified.c
          ? minified.c.map((c) => expandChildXPathObject.parse(c))
          : null,
      }
    },
  )

const expandParentXPathObject: ZodEffects<
  typeof SerializableParentXPathObjectMinified,
  SerializableParentXPathObject
> = SerializableParentXPathObjectMinified.transform((minified) => {
  return {
    tagName: minified.t,
    attrs: minified.a,
    parent: minified.p ? expandParentXPathObject.parse(minified.p) : null,
...
const expandChildXPathObject: ZodEffects<
  typeof SerializableChildXPathObjectMinified,
  SerializableChildXPathObject
> = SerializableChildXPathObjectMinified.transform((minified) => {
  return {
    tagName: minified.t,
    attrs: minified.a,
    parent: null,
...
export class ResourceParser {
  ...
  getParserForVersion(
    version: string,
  ): ZodType<ResourcePayload, ZodTypeDef, any> {
    return match(version)
      .when(
        (v) => semver.gte(v, '3.0.0'),
        () =>
          match(this.minify)
